...
interface QuestionClusterRequestBody {
...
function parseBody(body: unknown): QuestionClusterRequestBody {
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    const assignments = await questionClusterService.clusterEvidence(body);
